...
namespace DevoidEngine.Elemental.EditorUtils
{
    class EditorOutlinePass : RenderPass
    {
        ...
        Shader outlineShader = new Shader("Elemental/Assets/Shaders/outline/outline");
        Shader edgedetection = new Shader("Elemental/Assets/Shaders/outline/edgedetection");
