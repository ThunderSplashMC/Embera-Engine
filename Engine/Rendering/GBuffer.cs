...
namespace DevoidEngine.Engine.Rendering
{
    class GBuffer
    {
        ...
        {
            GL.BlitNamedFramebuffer(GBufferFBO, RenderGraph.LightBuffer.GetRendererID(), 0, 0, 1280, 720, 0, 0, 1280, 720, ClearBufferMask.ColorBufferBit, BlitFramebufferFilter.Nearest);
        }
    }
}
