...
namespace DevoidEngine.Engine.Core
{
    class Physics
    {
        ...
        public static OpenTK.Mathematics.Vector3 GetPosition(Matrix4 matrix)
        {
            return new OpenTK.Mathematics.Vector3(matrix.M41, matrix.M42, matrix.M43);
        }

        public static OpenTK.Mathematics.Vector3 GetPosition(BulletSharp.Math.Matrix matrix)
        {
            return new OpenTK.Mathematics.Vector3(matrix.Origin.X, matrix.Origin.Y, matrix.Origin.Z);
        }
        public static OpenTK.Mathematics.Vector3 GetRotation(BulletSharp.Math.Matrix matrix)
        {
            return new OpenTK.Mathematics.Vector3(matrix.Basis.Origin.X, matrix.Basis.Origin.Y, matrix.Basis.Origin.Z);
        }
    }
}
