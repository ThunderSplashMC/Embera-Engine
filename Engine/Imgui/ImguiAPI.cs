...
namespace DevoidEngine.Engine.Imgui
{
    ...
    public class ImguiAPI : IDisposable
    {
        ...
        public ImguiAPI(GameWindow gameWindow)
        {
            ...
            LoadIconFont("Elemental/Assets/Fonts/MaterialIcons-Regular.ttf", 16, (MaterialDesign.IconMin, MaterialDesign.IconMax16));
        ...
        public void CreateDeviceResources()
        {
            ...
            Console.WriteLine("VAO IS " + _vertexArray);
            Console.WriteLine("VBO IS " + _vertexBuffer);
